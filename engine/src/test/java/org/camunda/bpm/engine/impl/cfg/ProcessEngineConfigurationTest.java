...
import static org.camunda.bpm.engine.impl.cfg.ProcessEngineConfigurationImpl.TRANSACTION_ISOLATION_LEVEL_DEFAULT;
...
public class ProcessEngineConfigurationTest {
  ...
  public void validIsolationLevelPropertyIsSetCorrectly() {
    //given
    engineConfiguration.setTransactionIsolationLevel("serializable");
